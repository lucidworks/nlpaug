...
def init_back_translatoin_model(
    from_model_name,
    from_model_checkpt,
    to_model_name,
    to_model_checkpt,
    ...
    model = nml.Fairseq(
        ...
        from_model_checkpt=from_model_checkpt,
        to_model_name=to_model_name,
        to_model_checkpt=to_model_checkpt,
        tokenzier_name=tokenzier_name,
        bpe_name=bpe_name,
...
class BackTranslationAug(WordAugmenter):
    ...
    def get_model(
        ...
        return init_back_translatoin_model(
            from_model_name,
            from_model_checkpt,
            to_model_name,
            to_model_checkpt,
