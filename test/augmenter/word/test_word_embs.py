        ...
        if full_test_case:
            cls.augs.extend(
                [
                    ...
                    naw.WordEmbsAug(
                        model_type="glove",
                        model_path=model_dir + "glove.twitter.27B.50d.txt",
                    ),
                    naw.WordEmbsAug(
                        model_type="glove",
                        model_path=model_dir + "glove.twitter.27B.100d.txt",
                    ),
                    naw.WordEmbsAug(
                        model_type="glove",
                        model_path=model_dir + "glove.twitter.27B.200d.txt",
                    ),
                    naw.WordEmbsAug(
                        model_type="fasttext",
                        model_path=model_dir + "wiki-news-300d-1M-subword.vec",
                    ),
                    naw.WordEmbsAug(
                        model_type="fasttext",
                        model_path=model_dir + "crawl-300d-2M.vec",
                    ),
                    naw.WordEmbsAug(
                        model_type="fasttext",
                        model_path=model_dir + "crawl-300d-2M-subword.vec",
                    ),
                ]
            )
